...
\lhead{\small\color{ufamblue} Atividade: Scan de Redes WiFi --- Prof.\ Celso Barbosa Carvalho}
\cfoot{\thepage}
...
\thispagestyle{empty}
\begin{center}
  \includegraphics[width=4cm]{../mestrado_ppgee/ufam_logo.png}\\[6pt]
  ...
  {\LARGE\bfseries ATIVIDADE --- SCAN DE REDES WiFi}\\[12pt]
  {\large\bfseries Escaneamento com ESP32 e Análise de RSSI}\\[50pt]

  \begin{tabular}{rl}
    \textbf{Aluno:}    & Matheus Serrão Uchôa \\[4pt]
    \textbf{E-mail:}   & maktheus@gmail.com \\[4pt]
    \textbf{Professor:}& Prof.\ Celso Barbosa Carvalho \\
  \end{tabular}
...
\begin{center}
  ...
  {\Large\bfseries ATIVIDADE --- SCAN DE REDES WiFi\\[6pt]
  Escaneamento com ESP32 e Análise de RSSI}\\[40pt]
\end{center}
