...
\begin{center}
  ...
  {\large Matheus Serr\~ao Uch\^oa}\\[2pt]
...
Foi utilizada a imagem \texttt{testpattern1024.tif} ($1024 \times 1024$
pixels, 8\,bits, tons de cinza) do livro \emph{Digital Image Processing
Using MATLAB} (Gonzalez, Woods \& Eddins). A imagem contém múltiplas
regiões com características distintas de textura e frequência espacial,
tornando-a ideal para avaliar visualmente o comportamento de cada tipo
de padding.

\begin{figure}[ht]
  \centering
  \includegraphics[width=\linewidth]{images/comparison.png}
  \caption{Comparação entre a imagem original (\texttt{testpattern1024.tif},
           $1024\times1024$) e as imagens com zero padding e replicate padding
           ($1184\times1184$, i.e.\ $r=c=80$ pixels). O retângulo vermelho
           tracejado delimita a região da imagem original.}
...
\begin{table}[ht]
  ...
  \begin{tabular}{lcc}
    ...
    \midrule
    Original                 & 1024 & 1024 \\
    Zero Padding             & 1184 & 1184 \\
    Replicate Padding        & 1184 & 1184 \\
    \midrule
    \multicolumn{3}{l}{\small $1184 = 1024 + 2\times80$} \\
    \bottomrule
  \end{tabular}
\end{table}
