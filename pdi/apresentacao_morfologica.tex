...
%==============================================================
% SLIDE 17 — Pipeline detalhado
%==============================================================
\begin{frame}{Pipeline Aplicado: Segmenta\c{c}\~ao de Moedas}

\begin{center}
\includegraphics[width=0.95\textwidth]{apresentacao_imgs/pipeline_detalhado.png}
\end{center}

{\footnotesize Cada etapa do pipeline aplicada \`a imagem \textit{coins}: (1)~original, (2)~gradiente morfol\'ogico, (3)~abertura por reconstru\c{c}\~ao, (4)~fechamento por reconstru\c{c}\~ao, (5)~marcadores FG, (6)~marcadores BG (SKIZ), (7)~combina\c{c}\~ao, (8)~resultado final com \textbf{25 regi\~oes} (vs.\ 15.983 da watershed direta).}

\end{frame}

%==============================================================
% SLIDE 18 — Caso 1: Moedas
%==============================================================
\begin{frame}{Caso 1: Segmenta\c{c}\~ao de Moedas}

\begin{center}
\includegraphics[width=0.92\textwidth]{apresentacao_imgs/caso1_moedas.png}
\end{center}

\begin{alertblock}{An\'alise}
Watershed direta: \textbf{15.983 regi\~oes} (sobre-segmenta\c{c}\~ao extrema). M\'etodo proposto: \textbf{25 regi\~oes} --- cada moeda \'e segmentada individualmente com contornos precisos.
\end{alertblock}

\end{frame}

%==============================================================
% SLIDE 19 — Caso 2: Células
%==============================================================
\begin{frame}{Caso 2: Segmenta\c{c}\~ao de C\'elulas (Imagem Biom\'edica)}

\begin{center}
\includegraphics[width=0.92\textwidth]{apresentacao_imgs/caso2_celulas.png}
\end{center}

\begin{exampleblock}{An\'alise}
Imagem de mitose celular. Watershed direta: \textbf{16.766 regi\~oes}. M\'etodo proposto: \textbf{250 regi\~oes} --- redu\c{c}\~ao de $\sim$98,5\%, preservando as estruturas celulares relevantes.
\end{exampleblock}

\end{frame}

%==============================================================
% SLIDE 20 — Caso 3: Multi-escala
%==============================================================
\begin{frame}{Caso 3: Objetos Multi-Escala com Ru\'ido}

\begin{center}
\includegraphics[width=0.92\textwidth]{apresentacao_imgs/caso3_multiescala.png}
\end{center}

\begin{block}{An\'alise}
Imagem sint\'etica com 1 ret\^angulo grande, 1 c\'irculo m\'edio e 3 c\'irculos pequenos + ru\'ido gaussiano. Watershed direta: \textbf{17.350 regi\~oes}. M\'etodo proposto: \textbf{5 regi\~oes} --- exatamente o n\'umero correto de objetos.
\end{block}

\end{frame}

%==============================================================
% SLIDE 21 — Caso 4: Cameraman
%==============================================================
\begin{frame}{Caso 4: Imagem Real (Cameraman)}

\begin{center}
\includegraphics[width=0.92\textwidth]{apresentacao_imgs/caso4_cameraman.png}
\end{center}

\begin{block}{An\'alise}
Cena natural complexa. Watershed direta: \textbf{29.967 regi\~oes}. M\'etodo proposto: \textbf{8 regi\~oes} --- segmenta c\^amera, pessoa, c\'eu, grama e edif\'icios como regi\~oes coerentes.
\end{block}
...
%==============================================================
\begin{frame}{Compara\c{c}\~ao Quantitativa}

\begin{center}
\includegraphics[width=0.85\textwidth]{apresentacao_imgs/tabela_metricas.png}
\end{center}
...
\begin{itemize}
  \item Redu\c{c}\~ao de \textbf{99,7\%} a \textbf{99,97\%} no n\'umero de regi\~oes esp\'urias
  \item Caso multi-escala: n\'umero \textbf{exato} de objetos recuperado (5/5)
  \item Contornos fechados, \textbf{largura de 1 pixel}, m\'inima sub/sobre-segmenta\c{c}\~ao
  \item \textbf{Robusto} a ru\'ido gaussiano ($\sigma = 15$)
\end{itemize}
\end{alertblock}
