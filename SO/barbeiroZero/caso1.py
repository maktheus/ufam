...
def adicionarFila(tempo_descanso): # Realiza o controle da fila
    ...
    while (i < len(entrada)):
        ...
        obj.acquire()
        print("Entrou um cliente na fila")
        linha = entrada[i]
...
def atenderCliente(): # Realiza o atendimento dos clientes
...
RecrutaZero = Thread(target = atenderCliente) 
