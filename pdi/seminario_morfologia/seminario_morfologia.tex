...
\begin{frame}{Contexto: segmentação de imagens}
  ...
  \end{block}
  \vspace{0.3cm}
  \begin{block}{Abordagens clássicas}
    \begin{itemize}
...
\begin{frame}{Aplicação-alvo e o método base}
  \begin{block}{Aplicação-alvo do artigo}
    \begin{itemize}
  ...
  \begin{exampleblock}{Watershed (divisor de águas)}
    Método de segmentação por \alert{região} baseado em morfologia matemática,
    muito usado; encontra bordas por conjuntos fechados conexos.
  \end{exampleblock}
\end{frame}
